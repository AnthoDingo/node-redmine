...
Redmine.prototype.setHttps = function(options) {
  this.https = options;
}
...
Redmine.prototype.getVersion = function(id, callback) {
  if (typeof id == 'integer') {
    throw new Error('Error: Argument #1 id must be integer');
  }
...
Redmine.prototype.getTrackers = function(callback){
  this.request('GET', '/trackers.json', {}, callback);
};

Redmine.prototype.getIssueCategories = function(id, callback){
  if (typeof id == 'integer') {
    throw new Error('Error: Argument #1 id must be integer');
  }
